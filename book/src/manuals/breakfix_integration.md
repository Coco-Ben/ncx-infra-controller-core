...
The Release Instance API for NVIDIA NCX Infra Controller (NICo) now supports **issue reporting** and **automated repair workflows**. When releasing an instance, you can report problems to help improve system reliability.

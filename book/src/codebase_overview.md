...
- scout/ - `forge-scout`. A binary that runs on NVIDIA NCX Infra Controller (NICo) managed hosts and DPUs and executes various parts workflows on behalf of the site controller
